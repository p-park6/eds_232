...
fish_clean = read_csv(here("week_5", "data", "fish_clean.csv")) %>% 
...
In order to find the best model for the data, I will be using cross validation to tune the parameters for each of the models. This is accomplished by splitting the data into 10 (or 5?) folds for 10-fold cross validation.
...
```{r, include=FALSE}
#storing variables and dataframes as well as weird objects
load(file = here::here("week_5","data", "knn_tune.rda"))
```
...
#add type = prob, get the prob of all variables (predicting what that row will be)
#making class values into columns
...
test_roc_auc = roc_curve(train_predict2, 
                         habitat, 
                         .pred_bathydemersal, ###FINISH UP WITH CODE###
                         .pred_bathypelagic, 
                         .pred_benthopelagic,
                         .pred_demersal,
                         .pred_pelagic,
